...
<<<<<<< HEAD
  ...
  const cardBg = '#fff';
  const cardBorder = '2px solid #e85d0420';
  const cardShadow = '0 4px 12px rgba(232, 93, 4, 0.08)';
  const inputBg = '#fff';
  const inputColor = '#0f0e2e';
  const inputBorder = '2px solid #e85d0420';
  const textMain = '#e85d04';
  const textSub = '#0f0e2e';
  const textMuted = '#999';
  const tableHeaderBg = '#e85d0408';
  const tableRowAlt = '#fcfcfc';
  const modalBackdrop = 'rgba(0,0,0,0.6)';
